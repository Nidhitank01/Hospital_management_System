    ...
    {  
        ...
        scanf("%d", &n);
            ...
            for (i = 0, j = 0, k = 0, l = 0 , m=0 , o = 0; i < n; i++)
            {
                ...
                dp[i].bill[m].room_rent+dp[i].bill[m].other;
        ...
        case 2: // edit
        {
            ...
            if(flag==0)
            {
            	printf("*****Enter Unique id is not found , please enter correct id.*****");
            	goto id;
			}
        ...
        case 3: // bill
        {
            ...
            if(flag==0)
            {
            	printf("****Entered unique id is not found , please Enter correct unique id.****\n ");
            	goto bid;
			}
